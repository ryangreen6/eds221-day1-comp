...
# now working on our own! This is Ryan, not part of the example here lol.
...
toolik_chlorophyll$pprod_mg_available_c_m3_d <- na_if(toolik_chlorophyll$pprod_mg_available_c_m3_d, ".")
